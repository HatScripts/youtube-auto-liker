...
(() => {
  ...
  const SELECTORS = {
    ...
    LIKE_BUTTON: '#segmented-like-button button, #menu .YtLikeButtonViewModelHost button',
    DISLIKE_BUTTON: '#segmented-dislike-button button, #menu .YtDislikeButtonViewModelHost button'
  }
