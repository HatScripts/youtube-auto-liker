...
(() => {
  ...
  const SELECTORS = {
    ...
    LIKE_BUTTON: '#segmented-like-button button, #actions .YtLikeButtonViewModelHost button',
    DISLIKE_BUTTON: '#segmented-dislike-button button, #actions .YtDislikeButtonViewModelHost button'
  }
